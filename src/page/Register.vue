<template>
  <div class="page-register">
    <div class="header">
      <header>
        <a href="/index">
          <img class="site-logo" src="//s0.meituan.net/bs/fe-web-meituan/fa5f0f0/img/logo.png" alt="美团">
        </a>
        <div class="login">
          <span>已有美团账号</span>
    ...
    <div class="content">
      ...
      >
        <el-form-item label="用户名" prop="userName">
          <el-input class="fl" type="text" 
            v-model="registerForm.userName" 
            autocomplete="off"></el-input>
          <span class="fr">注册成功后，全美团通用</span>
        </el-form-item>
        ...
        <el-form-item>
          ...
          同意以下协议并注册</el-button>
          <div class=""><a href=""> 《美团网用户协议》 </a> <a href="">《美团网隐私协议》</a></div>
        </el-form-item>
      </el-form>
    </div>
    <footer>
